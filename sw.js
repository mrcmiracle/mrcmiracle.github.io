/* sw.js — offline support.
   ...
   information is worse than serving none.
     ...
     CSS/JS/fonts  stale-while-revalidate. Safe to serve instantly and update
                   in the background - a stylesheet cannot be dangerously out
                   of date.
     data + i18n   same. The library list changes rarely and an old copy is far
...
const PRECACHE = [
  ...
  '/smoke.html', '/privacy.html', '/impact.html', '/404.html',
  '/css/styles.css',
